...
산성비 테마 애니메이션과 접속자 수, 랭킹 진입 메뉴를 포함한 시작 화면입니다.

### Room Lobby

![Room lobby](docs/images/room-lobby.png)

방장이 게임 모드와 난이도를 조정하고, 참가자 목록과 채팅을 함께 볼 수 있는 로비 화면입니다.

### Gameplay

![Gameplay](docs/images/gameplay.png)

떨어지는 키워드를 입력해 점수를 얻고, pH 게이지와 실시간 점수판으로 멀티플레이 진행 상황을 확인할 수 있습니다.

### Leaderboard

![Leaderboard](docs/images/leaderboard.png)

언어와 난이도별로 최고 기록과 개인 기록을 조회할 수 있는 리더보드 화면입니다.
